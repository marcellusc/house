    ...
    class Latest_Updates extends Notice
    {
        ...
        public function notice_content()
        {
            $jltma_changelog_message = sprintf(
                ...
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list"> Notice not working issue fixed </span><br>', 'master-addons'),
                ...
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list"> Latest Elementor Compatibility </span><br>', 'master-addons'),
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list"> Latest Elementor Pro Compatibility </span><br>', 'master-addons'),
